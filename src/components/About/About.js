    ...
    >
      <Container>
        ...
        <Row>
          <Col md className="pe-3">
            <Bounce bottom>
              ...
              <p className="text-muted">
                ...
                Chevrons comprehensive range of investigative services have played a crucial role in helping millions of patients obtaining proper diagnostic services since its inception.
              </p>
              <p className="text-muted">
          ...
          <Col md className="pe-3">
            <Bounce bottom>
              ...
              <p className="text-muted">
                As the first homegrown healthcare group in Bangladesh, CCLL was incorporated on 22nd February, 1984 and commenced operations as the country’s sole integrated investigative laboratory on 16th May, 1984 in Chittagong. It was a pioneering venture in the field of integrated and automated diagnostics in Bangladesh Chevrons comprehensive range of investigative services have played a crucial role in helping millions of patients obtaining proper diagnostic services since its inception.
              </p>
        ...
        <Row className="mt-4">
          <Col md>
            <Bounce bottom>
              <h5 className="text-white">Sign up for our monthly update about new disease</h5>
              <p className="text-muted">
